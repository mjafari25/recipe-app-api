...
class PublicIngredentsApiTests(TestCase):
    ...
    def test_auth_required(self):
        """Test auth is required to retreiving ingredients."""
...
class PrivateIngredentsApiTests(TestCase):
    ...
    def test_retreive(self):
        ...
        Ingredient.objects.create(user=self.user, name='lake')
    ...
    def test_delete_ingredient(self):
        ...
        inredients = Ingredient.objects.filter(user=self.user)
        self.assertFalse(inredients.exists())
    ...
    def test_ingredients_unique(self):
        """Test filtered ingredients return a uniqe list."""
